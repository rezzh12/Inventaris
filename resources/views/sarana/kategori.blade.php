        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{ route('sarana.kategori.submit') }}" enctype="multipart/form-data">
                        @csrf
     ...
     <div class="modal fade" id="editMasukModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{ route('sarana.kategori.update') }}" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="form-group">
...
$(function() {
            $(document).on('click', '#btn-edit-jadwal', function() {
                ...
                $.ajax({
                    type: "get",
                    url: "{{ url('sarana/ajaxadmin/dataKategori') }}/" + id,
                    dataType: 'json',
                    success: function(res) {
                        $('#edit-nama').val(res.nama_kategori);
