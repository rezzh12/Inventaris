...
@section('content')
    <div class="container-fluid">
        <div class="card card-default">
            <div class="card-header">{{ __('Pengelolaan Ruangan') }}</div>
            <div class="card-body">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{ route('sarana.ruangan.submit') }}" enctype="multipart/form-data">
                        @csrf
     ...
     <div class="modal fade" id="editMasukModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{ route('sarana.ruangan.update') }}" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="form-group">
...
$(function() {
            $(document).on('click', '#btn-edit-jadwal', function() {
                ...
                $.ajax({
                    type: "get",
                    url: "{{ url('sarana/ajaxadmin/dataRuangan') }}/" + id,
                    dataType: 'json',
                    success: function(res) {
                        $('#edit-nama').val(res.nama_ruangan);
                        $('#edit-luas').val(res.luas);
