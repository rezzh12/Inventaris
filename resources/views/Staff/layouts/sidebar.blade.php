    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <!-- Add icons to the links using the .nav-icon class
               ...
               <li class="nav-item">
                <a href="{{ route('staff.perencanaan') }}" class="nav-link ">
              ...
              <li class="nav-item">
                <a href="{{ route('staff.pendistribusian') }}" class="nav-link ">
                  <i class="fas fa-university nav-icon"></i>
                  <p>Pendistribusian</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('staff.inventaris') }}" class="nav-link ">
                  <i class="fas fa-university nav-icon"></i>
                  <p>Inventaris</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('staff.pemeliharaan') }}" class="nav-link ">
                  <i class="fas fa-university nav-icon"></i>
                  <p>Pemeliharaan</p>
                </a>
              </li>
